using System.Web;
using SynapseVue.Client.Core.Controllers.Identity;
using SynapseVue.Server.Components;
using SynapseVue.Server.Models.Emailing;
using SynapseVue.Server.Models.Identity;
using SynapseVue.Server.Resources;
...
namespace SynapseVue.Server.Controllers.Identity;
