...
public class ProductConfiguration : IEntityTypeConfiguration<Product>
{
    public void Configure(EntityTypeBuilder<Product> builder)
    {
        ...
        builder.HasData(
            ...
            new Product { Id = 5, Name = "RFID-main", PIN = 25, Description = "RFIF sensor for mode change", CreatedOn = baseDate, LastSuccessActivity = baseDate, LastReadValue = "", CategoryId = 8 },
            new Product { Id = 6, Name = "Display-main", PIN = 0, Description = "Display, no pin needed", CreatedOn = baseDate, LastSuccessActivity = baseDate, LastReadValue = "", CategoryId = 5 },
            new Product { Id = 7, Name = "Camera0-AI-main", PIN = 0, Description = "Camera connected to PCI slot 0, no pin needed", CreatedOn = baseDate.AddDays(-19), LastSuccessActivity = baseDate, LastReadValue = "", CategoryId = 7 },
            new Product { Id = 8, Name = "Camera1-SERVER-main", PIN = 0, Description = "Camera connected to PCI slot 1, no pin needed", CreatedOn = baseDate.AddDays(-10), LastSuccessActivity = baseDate, LastReadValue = "", CategoryId = 7 }
            );
    }
}
